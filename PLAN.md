...
> **현황 (2026-07)**: Phase 0~2 완료. 데이터 규모는 조직 138·모델 127·제품 71·오픈소스 48·데이터셋 110·벤치마크 17·논문 234 = **745건**으로 MVP 목표(100+)를 크게 상회. GitHub Pages 배포 운영 중.
...
- [x] `data/` 데이터 입력 (목표 대비 대폭 초과, 현재 745건)
