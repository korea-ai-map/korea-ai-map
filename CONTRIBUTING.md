...
1. 항목 유형에 맞는 폴더에 `{id}.yaml` 파일을 만든다.
   `data/organizations/`, `data/models/`, `data/products/`, `data/open-source/`, `data/datasets/`, `data/benchmarks/`, `data/papers/`
2. `id`는 **파일명**이 됩니다. 소문자-케밥 표기, 전역 유일이며 점(`.`)은 쓰지 않습니다. 예: `lg-ai-research`, `exaone-35`
